...
client.on("message", async msg => {
      ...
      let guncelseviye = await db.fetch(`seviye_${msg.author.id + msg.guild.id}`,1);
      ...
      ** Bir seviye atladın! seviye ** ${guncelseviye ? guncelseviye : '2'} ** oldun ** <a:twich:836538116461690911>
`);  
  ...
  if (dba.fetch(`puan_${msg.author.id + msg.guild.id}`) > 300) {
