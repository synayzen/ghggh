...
exports.run = async (client, msg, args) => {
  ...
  if (msg.channel.id !== '801730953055567922') return msg.channel.send(`${yasak} **Bu komutun kullanımı, bu kanalda engellenmiştir.Lütfen <#801730953055567922>'da dene.'**`).then(m => m.delete(5000));
